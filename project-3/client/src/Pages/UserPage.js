      ...
      <div>
        <Wrapper>
          ...
          {this.state.CarName.length ? (
            <List>
              {this.state.CarName.map(car => (
                <ListItem
                  className="pure-menu-item pure-menu-selected pure-menu-link"
                  key={car.id}
                >
                  {car.nickname}{" "}
                </ListItem>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>Add a Car to your profile</DialogContentText>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>Add a Trip for your Car</DialogContentText>
              <br />
              <TextField
                id="date"
                onChange={this.handleInputChange}
              ...
              {this.state.TripType.length ? (
                <TPList>
                  {this.state.TripType.map(trip => (
                    <TPItem key={trip.id}>{trip.purpose}</TPItem>
                  ))}
                </TPList>
              ) : (
                <h6> null </h6>
